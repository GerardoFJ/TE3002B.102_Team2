...
class MissionVisualizer:
    ...
    def __init__(self, coord=None, stride=15):
        ...
        self.xlim = (-1.0, 14.0)
        self.ylim = (-1.0, 5.5)
        # Cuadricula y caminos: se leen del coordinador tras run()
        # (el coord calcula sus paths internamente via camara)
    ...
    def _draw_static(self, ax, mpatches):
        ...
        # Cuadricula 1m y lineas de path pintadas en el suelo.
        # Los paths los calcula el coordinador via camara; los leemos aquí.
        coord = self.coord
        coord._grid.draw(ax,
                         paths_ordered=coord._paths_ordered,
                         obstacle_cells=coord._obstacle_cells,
                         blocked_cells=coord._blocked_cells)
